...
// ********************************************************************
//
// $Id: HistoMessenger.cc,v 1.2 2010-09-17 18:45:43 maire Exp $
...
{
  factoryCmd = new G4UIcmdWithAString("/histo/setFileName",this);
  factoryCmd->SetGuidance("set name for the histograms file");

  typeCmd = new G4UIcmdWithAString("/histo/setFileType",this);
  typeCmd->SetGuidance("set histograms file type: hbook, root, XML");
  typeCmd->SetCandidates("hbook root XML");

  optionCmd = new G4UIcmdWithAString("/histo/setFileOption",this);
...
/*  histoCmd = new G4UIcommand("/histo/setHisto",this);
  ...
  prhistoCmd = new G4UIcmdWithAnInteger("/histo/printHisto",this);
  prhistoCmd->SetGuidance("print histo #id on ascii file");
  prhistoCmd->SetParameterName("id",false);
  prhistoCmd->SetRange("id>0");
    
  rmhistoCmd = new G4UIcmdWithAnInteger("/histo/removeHisto",this);
